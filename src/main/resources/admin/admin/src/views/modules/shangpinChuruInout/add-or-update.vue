        ...
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.shangpinChuruInoutContent"  label="备注" prop="shangpinChuruInoutContent">
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.shangpinChuruInoutContent = _this.ruleForm.shangpinChuruInoutContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.shangpinChuruInoutContent = this.ruleForm.shangpinChuruInoutContent.replaceAll(this.$base.url,"");
                        this.$http({
