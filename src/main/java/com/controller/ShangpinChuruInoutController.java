    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shangpinChuruInout !=null){
            ...
            //级联表 员工
            //级联表
            YuangongEntity yuangong = yuangongService.selectById(shangpinChuruInout.getYuangongId());
            if(yuangong != null){
    ...
    */
    ...
    public R save(@RequestBody ShangpinChuruInoutEntity shangpinChuruInout, HttpServletRequest request){
        ...
        if(false)
            ...
            shangpinChuruInout.setYuangongId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<ShangpinChuruInoutEntity> queryWrapper = new EntityWrapper<ShangpinChuruInoutEntity>()
            .eq("yuangong_id", shangpinChuruInout.getYuangongId())
    ...
    */
    ...
    public R outShangpinChuruInoutList(@RequestBody  Map<String, Object> params,HttpServletRequest request){
        ...
        ShangpinChuruInoutEntity shangpinChuruInoutEntity = new ShangpinChuruInoutEntity<>();
            if("员工".equals(role))
                shangpinChuruInoutEntity.setYuangongId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ShangpinChuruInoutEntity shangpinChuruInoutEntity = new ShangpinChuruInoutEntity();
//                            shangpinChuruInoutEntity.setYuangongId(Integer.valueOf(data.get(0)));   //员工 要改的
