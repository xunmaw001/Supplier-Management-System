...
*/
@TableName("tuihuodan")
public class TuihuodanView extends TuihuodanEntity implements Serializable {
	...
	* 退货类型的值
	*/
	@ColumnInfo(comment="退货类型的字典表值",type="varchar(200)")
	private String tuihuodanValue;
	...
	public TuihuodanView() {

	}

	public TuihuodanView(TuihuodanEntity tuihuodanEntity) {
		try {
			BeanUtils.copyProperties(this, tuihuodanEntity);
	...
	* 获取： 退货类型的值
	*/
	public String getTuihuodanValue() {
		return tuihuodanValue;
	}
	/**
	* 设置： 退货类型的值
	*/
	public void setTuihuodanValue(String tuihuodanValue) {
		this.tuihuodanValue = tuihuodanValue;
	}
	...
	public String toString() {
		return "TuihuodanView{" +
			", tuihuodanValue=" + tuihuodanValue +
